    ...
    <div className='w-full h-full flex flex-col justify-center items-center py-12'>
        ...
        <form action="" className='w-[800px]  poppins flex flex-col gap-6 py-4'>
            ...
            <div className='flex flex-col '>
                ...
                <textarea className=' px-4 py-2 rounded-md' name="" id="" cols="30" rows="10"></textarea>
            </div>
            <div className='flex flex-col '>
            ...
            <div className='flex justify-center gap-6'>
                <button className='w-[100px] px-4 py-2 bg-green-400 rounded-md'>Add</button>
                <Link to={'/event'}><button className='w-[100px] px-4 py-2 bg-red-400 rounded-md'>Cancel</button></Link>
            </div>
        </form>
    </div>
  )
