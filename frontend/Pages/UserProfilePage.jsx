...
const UserProfilePage = ({ userType }) => {
  const initialProfile = {
    ...
    about: 'I am a Malaysian singer, songwriter and maleactor. I was a champion in a competition onYouTube and the son of a veteran singer ofthe 1980s, Suliza Salam.',
    currentPassword: '',
    newPassword: ''
  };
    ...
    <div className='text-black poppins px-[12%] py-10'>
      {userType == 'User' || userType == 'Organization' ?
        ...
        <div className="profile-info">
          ...
          {userType == 'User' ? <div className="info-row">
          ...
          {userType == 'User' ?<div className="info-row">
            ...
            {userType == 'Organization' ? <div className="info-row">
        ...
        <div className="container container-below-header">
          <div className="profile-section">
            ...
            <div className="profile-info">
              <div className="profile-container">
                <div className="profile-pic flex justify-center">
                  <img className='w-full h-full object-cover border border-gray-400' src={profile.image} alt="Profile Picture" id="profilePic" />
                </div>
                <div className="profile-name">{profile.stageName}</div>
              </div>
              <div className="info-row">
