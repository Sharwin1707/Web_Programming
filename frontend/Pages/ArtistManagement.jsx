                    ...
                    <tbody>
                        {data.map((bookingData,i) => (
                            <tr className="bg-white border text-center hover:bg-gray-50 text-black dark:hover:bg-gray-600">
                                ...
                                <td>
                                    <button className='bg-gray-500 px-4 py-2 rounded-md'>View</button>
                                    
                                </td>
                                <td className='flex gap-2 p-2'>
                                    <button className='bg-green-500 px-4 py-2 rounded-md'>Accept</button>
                                    <button className='red text-white px-4 py-2 rounded-md'>Reject</button>
                                </td>
