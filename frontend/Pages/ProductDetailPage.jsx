...
const ProductDetailPage = () => {
  ...
  return (
    <div className="mx-[12%] my-12">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-12">
        ...
        <div className="w-[500px] josefin ">
          ...
          <div className="flex gap-3 mt-4">
            <button
              onClick={addToCart}
              className="py-2 px-4 bg-[#dc3545] rounded-md flex justify-center items-center gap-2"
            >
      ...
      <h1 className="text-center text-4xl my-8 border-b-4 border- border-green-500">
        FEATURED PRODUCTS
      </h1>
      <div className="flex flex-wrap justify-center gap-4">
        {shopData.slice(0, 5).map((data, i) => (
          <div className="flex flex-col justify-center items-center p-2 border rounded-md">
            ...
            <button
              onClick={addToCart}
              className="w-max py-2 px-4 rounded-full border-2 border-green-500 hover:bg-green-500 hover:text-white "
            >
              Add to Cart
            </button>
          </div>
